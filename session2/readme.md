...
To this extent, it is good practice to check every piece of the code related to the callback: was it was passed, may you call it with or without the parameters you intend to pass out?
